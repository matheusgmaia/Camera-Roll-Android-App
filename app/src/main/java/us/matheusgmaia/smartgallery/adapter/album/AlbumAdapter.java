package us.matheusgmaia.smartgallery.adapter.album;
...
import us.matheusgmaia.smartgallery.adapter.AbstractRecyclerViewAdapter;
import us.matheusgmaia.smartgallery.adapter.SelectorModeManager;
import us.matheusgmaia.smartgallery.adapter.album.viewHolder.AlbumItemHolder;
import us.matheusgmaia.smartgallery.adapter.album.viewHolder.GifViewHolder;
import us.matheusgmaia.smartgallery.adapter.album.viewHolder.PhotoViewHolder;
import us.matheusgmaia.smartgallery.adapter.album.viewHolder.RAWImageHolder;
import us.matheusgmaia.smartgallery.adapter.album.viewHolder.VideoViewHolder;
...
import us.matheusgmaia.smartgallery.data.models.Gif;
import us.matheusgmaia.smartgallery.data.models.Photo;
import us.matheusgmaia.smartgallery.data.models.RAWImage;
import us.matheusgmaia.smartgallery.data.models.Video;
import us.matheusgmaia.smartgallery.tensorFlowFilter.ImageClassifier;
import us.matheusgmaia.smartgallery.ui.ItemActivity;
import us.matheusgmaia.smartgallery.ui.MainActivity;
...
public class AlbumAdapter extends AbstractRecyclerViewAdapter<Album> {
    ...
    public ArrayList<AlbumItem> mFilteredDataSet;
...
/*
                        ...
                        .into(new SimpleTarget<Bitmap>() {
                            ...
                            public void onResourceReady(@NonNull Bitmap bitmap, @Nullable Transition<? super Bitmap> transition) {
                                ...
                                if(classifier != null){
                                    ...
                                    textToShow = classifier.classifyFrame(classifier.getResizedBitmap(bitmap, ImageClassifier.DIM_IMG_SIZE_X, ImageClassifier.DIM_IMG_SIZE_Y));
                                    Log.d("TF", textToShow);
                                }
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (getSelectorMode()) {
                    ...
                    if(album != null){
                        album.setAlbumItems(mFilteredDataSet);
                        intent.putExtra(ItemActivity.VIEW_ONLY, true);
    ...
    public void setmFilteredDataSet(ArrayList<AlbumItem> mFilteredDataSet) {
        this.mFilteredDataSet = mFilteredDataSet;
        notifyDataSetChanged();
    }
}