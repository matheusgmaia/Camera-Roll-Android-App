...
import us.matheusgmaia.smartgallery.adapter.item.InfoRecyclerViewAdapter;
import us.matheusgmaia.smartgallery.adapter.item.viewHolder.ViewHolder;
import us.matheusgmaia.smartgallery.adapter.item.ItemAdapter;
...
import us.matheusgmaia.smartgallery.util.ParallaxTransformer;
import us.matheusgmaia.smartgallery.util.animators.ColorFade;
import us.matheusgmaia.smartgallery.util.MediaType;
import us.matheusgmaia.smartgallery.util.SimpleTransitionListener;
