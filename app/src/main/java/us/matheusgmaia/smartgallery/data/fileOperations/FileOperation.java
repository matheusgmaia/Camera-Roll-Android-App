package us.matheusgmaia.smartgallery.data.fileOperations;
...
import us.matheusgmaia.smartgallery.util.ExifUtil;
...
public abstract class FileOperation extends IntentService implements Parcelable {
    ...
    public static final String RESULT_DONE = "us.matheusgmaia.smartgallery.data.FileOperations.FileOperation.RESULT_DONE";
    public static final String FAILED = "us.matheusgmaia.smartgallery.data.FileOperations.FileOperation.FAILED";
    public static final String NEED_REMOVABLE_STORAGE_PERMISSION = "us.matheusgmaia.smartgallery.data.FileOperations.FileOperation.NEED_REMOVABLE_STORAGE_PERMISSION";
                            ...
                            if (new File(path).exists()) {
                                ...
                                if (albumItem instanceof Video) {
                                    ...
                                    try {
                                        ...
                                        Locale locale = us.matheusgmaia.smartgallery.util.Util.getLocale(context);
